...
import { SITE_CONTENT, T, type SiteContent } from "@/lib/site-content";

// ─── Types, content (SITE_CONTENT) and theme (T) live in lib/site-content.ts ────
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 12, color: T.textMuted, marginTop: 12 }}>
              © 2025–2026 Andienads Management. All rights reserved. | Made by Andienads
              Management
            </p>
          </div>
        </footer>
